package tbc.techbytecare.kk.androidcryptocurrency.Adapter;
...
import tbc.techbytecare.kk.androidcryptocurrency.ViewHolder.CoinViewHolder;
...
public class CoinAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holderItem.seven_day_change.setText(item.getPercent_change_7d()+"%");
        ...
        holderItem.seven_day_change.setTextColor(item.getPercent_change_7d().contains("-")?
                Color.parseColor("#FF0000"):Color.parseColor("#32CD32"));
    }
